...
- [CAPABILITIES.md](CAPABILITIES.md) - What CVForge supports today.
- [DATABASE.md](DATABASE.md) - Tables, RLS expectations, and migration ledger.
- [API_ROUTES.md](API_ROUTES.md) - Server routes, inputs, outputs, auth.
