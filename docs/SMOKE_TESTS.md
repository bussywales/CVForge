...
- Billing portal: “Manage in Stripe” / “Continue to Stripe” open Stripe portal via /api/billing/portal; if portal fails, ErrorBanner shows requestId; portal attempts log billing_portal_* events.
