...
- Billing portal: “Manage in Stripe” / “Continue to Stripe” open Stripe portal via /api/billing/portal; if portal fails, it redirects back with portal_error=1&req=<id> and Billing shows ErrorBanner with requestId; portal attempts log billing_portal_* events.
