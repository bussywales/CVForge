export function buildOpsIncidentsLink({ window = "15m", surface, code, signal, from = "ops_status" }: { window?: string; surface?: string | null; code?: string | null; signal?: string | null; from?: string }) {
