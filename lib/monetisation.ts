...
export type MonetisationEventName =
  ...
  | "pack_export_clicked"
  | "pack_exported"
  | "pack_version_selected"
  | "packs_generate_clicked"
  | "packs_generate_success"
  | "packs_generate_failed"
  | "packs_export_clicked"
  | "packs_copy_output_clicked"
  | "packs_version_selected"
  | "checkout_started"
  ...
  | "billing_resolution_confirm_yes"
  | "billing_resolution_confirm_no"
  ...
  | "ops_help_search"
  | "ops_help_toc_click"
  | "ops_help_copy_link_click"
  | "ops_help_training_view"
  | "ops_help_drill_view"
  | "ops_help_drill_action_click"
  | "ops_help_quickcard_view"
  | "ops_help_template_copy"
  | "ops_help_print_view_toggle"
  | "ops_help_training_report_copied"
  | "ops_training_scenario_create_click"
  | "ops_training_scenario_created"
  | "ops_training_scenario_deactivate_click"
  | "ops_training_link_click"
  | "ops_training_list_view"
  | "ops_training_prefilled_link_opened"
  | "ops_training_scenario_marked"
  | "ops_training_copy_request_id"
  | "ops_training_copy_event_id"
  | "ops_training_copy_all_ids"
  | "ops_training_open_case"
  ...
  | "ops_case_search_submit"
  | "ops_case_search_clear"
  | "ops_case_view"
  | "ops_case_view_open"
  | "ops_case_snippet_copy"
  | "ops_case_notes_save"
  | "ops_case_checklist_toggle"
  | "ops_case_close"
  | "ops_case_training_evidence_copy"
  | "ops_case_claim"
  | "ops_case_release"
  | "ops_case_assign"
  | "ops_case_status_change"
  | "ops_case_priority_change"
  | "ops_case_evidence_add"
  | "ops_case_template_copy"
  | "ops_case_conflict"
  | "ops_case_load_error"
  | "ops_case_alerts_view"
  | "ops_case_alerts_open_click"
  | "ops_case_incidents_view"
  | "ops_case_incidents_open_click"
  | "ops_case_incidents_widen_click"
  | "ops_case_audits_view"
  | "ops_case_audits_open_click"
  | "ops_case_webhooks_view"
  | "ops_case_webhooks_open_click"
  | "ops_case_billing_view"
  | "ops_case_billing_recheck_click"
  | "ops_case_billing_open_click"
  | "ops_case_resolution_view"
  | "ops_case_resolution_open_click"
  | "ops_case_watch_open_click"
  | "ops_case_context_fetch"
  | "ops_case_context_resolve"
  | "ops_case_context_upsert"
  | "ops_case_context_attach"
  | "ops_case_context_copy_userId"
  | "ops_case_audit_view"
  | "ops_cases_view"
  | "ops_cases_view_selected"
  | "ops_cases_view_saved"
  | "ops_cases_view_saved_as"
  | "ops_cases_view_manage"
  | "ops_cases_filter_change"
  | "ops_cases_filter_chip_clicked"
  | "ops_cases_sort_change"
  | "ops_cases_sort_changed"
  | "ops_cases_sla_filter_used"
  | "ops_cases_sla_tooltip_opened"
  | "ops_cases_poll_tick"
  | "ops_cases_copy_request_id"
  | "ops_cases_copy_user_id"
  | "ops_cases_copy_reason"
  | "ops_cases_claim"
  | "ops_cases_release"
  | "ops_cases_status_change"
  | "ops_cases_priority_change"
  | "ops_cases_open_case"
  | "ops_cases_open_why"
  | "ops_cases_open_case_clicked"
  | "ops_case_back_to_queue_clicked"
  | "ops_cases_summary_view"
  | "ops_cases_load_error"
  | "ops_cases_reason_render"
  | "ops_request_context_upsert"
  | "ops_status_rag_view"
  ...
  | "ops_alert_test_fire"
  | "ops_alerts_test_click"
  | "ops_alerts_test_send_click"
  | "ops_alerts_test_send_clicked"
  | "ops_alerts_test_sent_success"
  | "ops_alerts_test_sent_deduped"
  | "ops_alerts_test_success"
  | "ops_alerts_test_error"
  | "ops_alerts_test_cooldown_started"
  | "ops_alerts_test_cooldown_ended"
  | "ops_alerts_test_events_auto_expand"
  | "ops_alerts_test_poll_start"
  | "ops_alerts_test_poll_stop"
  | "ops_alerts_test_poll_found"
  | "ops_alerts_webhook_test_click"
  | "ops_alerts_webhook_test_queued"
  | "ops_alerts_deliveries_view"
  | "ops_alerts_deliveries_filter_click"
  | "ops_alerts_delivery_row_expand"
  | "ops_alerts_delivery_support_copy"
  | "ops_alerts_webhook_config_view"
  | "ops_alerts_webhook_not_configured_blocked"
  | "ops_alerts_webhook_notify_sent"
  | "ops_alerts_notify_attempt"
  | "ops_alerts_notify_delivered"
  | "ops_alerts_notify_failed"
  | "ops_alerts_ack_token_created"
  | "ops_alerts_ack_token_mint_success"
  | "ops_alerts_ack_token_mint_error"
  | "alerts_ack_public_success"
  | "alerts_ack_public_failed"
  | "ops_alerts_ack_public_success"
  | "ops_alerts_ack_public_error"
  | "ops_alerts_ack_click"
  | "ops_alerts_ack_link_copy"
  | "ops_alerts_ack_link_open"
  | "ops_alerts_ack_ui_state_change"
  | "ops_alerts_delivery_view"
  | "ops_alerts_delivery_copy_ref"
  | "ops_alerts_ack_view"
  | "ops_alerts_ack_submit"
  | "ops_alerts_ack_submit_success"
  | "ops_alerts_ack_submit_deduped"
  | "ops_alerts_ack_submit_error"
  | "ops_alerts_ack_curl_copy"
  | "ops_alert_claim_click"
  | "ops_alert_claim_success"
  | "ops_alert_claim_error"
  | "ops_alert_release_click"
  | "ops_alert_release_success"
  | "ops_alert_release_error"
  | "ops_alert_snooze_click"
  | "ops_alert_snooze_success"
  | "ops_alert_snooze_error"
  | "ops_alert_unsnooze_click"
  | "ops_alert_unsnooze_success"
  | "ops_alert_unsnooze_error"
  | "ops_alert_handoff_note_save"
  | "ops_alert_workflow_load_error"
  | "ops_alerts_load_error"
  | "ops_alerts_load_ok"
  | "ops_alerts_webhook_setup_click"
  | "ops_alert_handled_click"
  | "ops_alert_handled_save"
  | "ops_alert_handled_error"
  | "ops_alert_handled_view"
  | "ops_access_invite_view"
  | "ops_access_invite_grant"
  | "ops_access_invite_revoke"
  | "ops_access_invite_copy_instructions"
  | "ops_early_access_search"
  | "ops_early_access_invite_create"
  | "ops_early_access_invite_copy_link"
  | "ops_early_access_invite_copy_instructions"
  | "ops_early_access_invite_revoke"
  | "early_access_invite_claim_attempt"
  | "early_access_invite_claim_success"
  | "early_access_invite_claim_skipped"
  | "early_access_gate_allowed"
  | "early_access_gate_blocked"
  | "onboarding_card_view"
  | "onboarding_step_cta_click"
  | "onboarding_skip_week"
  | "onboarding_dismiss_local"
  | "onboarding_step_auto_completed"
  | "onboarding_completed"
  | "invite_attribution_claim_attempt"
  | "invite_attribution_claim_success"
  | "invite_attribution_claim_already_claimed"
  | "invite_attribution_claim_failed"
  | "ops_funnel_view"
  | "ops_funnel_refresh"
  | "ops_funnel_rate_limited"
  | "ops_access_invite_template_copy"
  | "invite_landing_view"
  | "invite_landing_continue_click"
  | "invite_landing_claim_click"
  | "invite_landing_invalid_view"
  | "invite_support_snippet_copy"
  | "invite_claim_banner_view"
  | "invite_claim_banner_retry_click"
  | "invite_claim_banner_copy"
  | "invite_claim_banner_dismiss"
  | "invite_claim_success_banner_view"
  | "invite_claim_success_cta_click"
  | "invite_claim_fail_why_open"
  | "ops_funnel_groupby_source_view"
  | "ops_funnel_filter_change"
  | "ops_funnel_copy_link"
  | "ops_user_invite_attribution_view"
  ...
  | "ops_incidents_widen_click"
  | "ops_incidents_from_alerts_view"
...
export async function logMonetisationEvent(
  ...
  return await createApplicationActivity(supabase, userId, {
